...
Passionate about data science and eager to get practical experience and want to use my skills to help organizations succeed.
"""
...
st.write("---")
st.write("⭐ [Data Science and Analytics with Advanced ML Track](https://drive.google.com/file/d/1ycorUogvm0WmUfbCisSfg1RxvBRDMehI/view?usp=sharing)")
...
# Add footer
st.write('---')
st.write('© Pranay Dilip Salkar  |  Last updated: july 2024')
